...
public class AutoSuggestor {
    ...
    private DocumentListener documentListener = new DocumentListener() { // used when the person types!
        @Override
...
class SuggestionLabel extends JLabel {
    ...
    private void initComponent() {
        ...
        addMouseListener(new MouseAdapter() { // -- Used for selection of word --
            @Override
    ...
    private void replaceWithSuggestedText() {
    	// ...called when word is to be replaced....
    ...
    public static class Test 
    {
        public Test() {
            ...
            new AutoSuggestor(f, frame, null, Color.WHITE.brighter(), Color.BLUE, Color.RED, 0.75f) {
                @Override
                boolean wordTyped(String typedWord) {
